...
public class SimpleSlice {
  public static void main(String[] args) throws WalaException, CancelException, InvalidClassFileException, IOException {
    //
    ...
    doSlicing(
        "E:\\eclipse-workspace\\BytemanTest",
        "Jlu.BytemanTest.App0#reduce",
        "add",
        0,
        dOptions,
        cOptions);
    ...
    public static void doSlicing(String appJar, String caller, String callee, int lineNumber,
        ...
        String[] srcCls = {"LJlu/BytemanTest/Demo"};
