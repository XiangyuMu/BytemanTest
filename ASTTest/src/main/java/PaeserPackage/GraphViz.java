...
public class GraphViz {
    ...
    private static String TEMP_DIR = "E:\\eclipse-workspace\\ASTTest"; // Windows，此处为生成图片的未知（不能为c盘根目录，原因未知）
    //private static String DOT = "dot"; // Linux
    private static String DOT = "D:\\Program Files\\Graphviz 2.44.1\\bin\\dot.exe";//dot.exe的位置
